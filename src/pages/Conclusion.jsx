        ...
        <div className="mx-auto max-w-3xl px-5 py-16 md:px-8 md:py-20">
          ...
          <ol className="mt-6 space-y-4">
            {[
              ...
              <Reveal as="li" key={q} delay={i * 90} className="flex gap-4 rounded-xl bg-card p-5">
          ...
          <Reveal as="div" className="mt-12 flex flex-col items-center gap-4 rounded-2xl bg-card px-6 py-12 text-center">
